...
class APIView(View):
    ...
    authentication_classes = api_settings.DEFAULT_AUTHENTICATION_CLASSES  # 配置文件
    ...
    def initialize_request(self, request, *args, **kwargs):
        ...
        return Request(
            ...
            authenticators=self.get_authenticators(),  # 拿到[BasicAuthentication(),]
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        获取request,request._request
        获取认证类的对象,request.authentications
        1、封装request
        """
        request = self.initialize_request(request, *args, **kwargs)
        # 获取原生request:request._request
        # 获取认证类对象,request.authentication
